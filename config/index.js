export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx5effa53c48c60d55",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "a2c0b577cc2d2a2ab1fb2e33587a3fb6",
  ...
  USERS: [
    {
      ...
      id: "og-1B5zmCdvAiHtSSGZ0dYR7a0Sc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "lqL3ao-zOcwxQVWO5wgN6ehM1vJ-1l5lSjh3nDhpjjU",
      // 所在省份
      province: "江西", 
      // 所在城市
      city: "南昌", 
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "宝贝", "year": "1999", "date": "06-28"},
